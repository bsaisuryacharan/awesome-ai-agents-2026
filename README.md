...
- [mcp-stack](https://github.com/CharanBharathula/mcp-stack) - Unified Model Context Protocol (MCP) server for executing code and managing files (🏷️ `Python` `MCP` `CLI`).
